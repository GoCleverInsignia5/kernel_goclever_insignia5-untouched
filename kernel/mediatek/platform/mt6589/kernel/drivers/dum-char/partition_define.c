...
struct excel_info PartInfo[PART_NUM]={
			...
			{"expdb",10485760,0x4380000, EMMC, 0,USER},
			{"android",681574400,0x4d80000, EMMC, 5,USER},
			{"cache",132120576,0x2d780000, EMMC, 6,USER},
			{"usrdata",8589934592,0x35580000, EMMC, 7,USER},
			{"fat",0,0x235580000, EMMC, 8,USER},
